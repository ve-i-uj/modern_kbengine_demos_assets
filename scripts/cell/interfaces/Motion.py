...
from assetsapi.interfaces.motion import ICellMotion

logger = logging.getLogger()


class Motion(ICellMotion):
    ...
    def randomWalk(self, basePos):
        ...
        while True:
            ...
            if self.canNavigate():
                ...
                destPos = Vector3(basePos.x + x, basePos.y, basePos.z + z)
    ...
    def gotoPosition(self, position: Vector3, dist=0.0):
        """
        virtual method.
        移动到位置
        """
        ...
        if self.canNavigate():
            ...
            self.moveToPoint(destPos, speed, 0, None, True, False)
